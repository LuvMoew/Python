...
#-------------------------------------------------------
#Ví dụ 4 Xử lý sự kiện khi nhấn nút Click Me
from tkinter import * 
window = Tk() 
window.title("Welcome to EAUT") 
window.geometry('350x200') 
...
#--------------------------------------------------
#Ví dụ 5: Không nhất thiết tên hàm để xử lý sự kiện click là clicked như trên
from tkinter import * 
...
chk = Checkbutton(window, text='Choose mee!!!!', var=chk_state) 
...
#-------------------------------------------------------
#Ví dụ 11: # Làm việc với Messagebox 
from tkinter import * 
from tkinter import messagebox 
window = Tk() 
window.title("Welcome to EAUT") 
